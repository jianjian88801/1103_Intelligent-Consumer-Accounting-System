 ...
 */
    ...
    public R barSum(@RequestParam Map<String,Object> params, HttpServletRequest request){
    ...
    public R barCount(@RequestParam Map<String,Object> params, HttpServletRequest request){
