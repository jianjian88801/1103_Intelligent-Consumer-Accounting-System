    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="支出唯一编号" prop="zhichuUuidNumber">
                       <el-input v-model="ruleForm.zhichuUuidNumber"
                                 placeholder="支出唯一编号" clearable  :readonly="ro.zhichuUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="支出唯一编号" prop="zhichuUuidNumber">
                           <el-input v-model="ruleForm.zhichuUuidNumber"
                                     placeholder="支出唯一编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="支出名称" prop="zhichuName">
                       <el-input v-model="ruleForm.zhichuName"
                                 placeholder="支出名称" clearable  :readonly="ro.zhichuName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="支出名称" prop="zhichuName">
                           <el-input v-model="ruleForm.zhichuName"
                                     placeholder="支出名称" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="支出类型" prop="zhichuTypes">
                        <el-select v-model="ruleForm.zhichuTypes" :disabled="ro.zhichuTypes" placeholder="请选择支出类型">
                            <el-option
                                v-for="(item,index) in zhichuTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="支出类型" prop="zhichuValue">
                        <el-input v-model="ruleForm.zhichuValue"
                            placeholder="支出类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="支出金额" prop="zhichuNumber">
                       <el-input v-model="ruleForm.zhichuNumber"
                                 placeholder="支出金额" clearable  :readonly="ro.zhichuNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="支出金额" prop="zhichuNumber">
                           <el-input v-model="ruleForm.zhichuNumber"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="支出原因" prop="shangjiaContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.shangjiaContent" label="支出原因" prop="shangjiaContent">
                            <span v-html="ruleForm.shangjiaContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="支出时间" prop="shoruTime">
                        <el-date-picker
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.shoruTime" label="支出时间" prop="shoruTime">
    ...
    export default {
        data() {
            return {
                ...
                ruleForm: {
                    yonghuId: '',
                    zhichuUuidNumber: new Date().getTime(),
                    zhichuName: '',
                    zhichuTypes: '',
                    zhichuNumber: '',
                    shangjiaContent: '',
                ...
                rules: {
                   ...
                   zhichuUuidNumber: [
                              { required: true, message: '支出唯一编号不能为空', trigger: 'blur' },
                          ],
                   zhichuName: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=zhichu_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.zhichuTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`zhichu/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.zhichuCrossAddOrUpdateFlag = false;
                                        this.parent.search();
